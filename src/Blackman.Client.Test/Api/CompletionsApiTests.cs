...
namespace Blackman.Client.Test.Api
{
    ...
    public sealed class CompletionsApiTests : ApiTestsBase
    {
        ...
        public async Task CompletionsAsyncTest()
        {
            CompletionRequest completionRequest = default!;
            Client.Option<string?> xProviderApiKey = default!;
            var response = await _instance.CompletionsAsync(completionRequest, xProviderApiKey);
            var model = response.Ok();
            Assert.IsType<CompletionResponse>(model);
        }
    }
}
