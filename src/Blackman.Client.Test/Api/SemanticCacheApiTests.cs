...
{
    /// <summary>
    ///  Class for testing SemanticCacheApi
    /// </summary>
    public sealed class SemanticCacheApiTests : ApiTestsBase
    {
        private readonly ISemanticCacheApi _instance;

        public SemanticCacheApiTests(): base(Array.Empty<string>())
        {
            _instance = _host.Services.GetRequiredService<ISemanticCacheApi>();
        }
        ...
        public async Task GetConfigAsyncTest()
        {
            ...
            Assert.IsType<SemanticCacheConfig>(model);
        }
        ...
        {
            var response = await _instance.GetStatsAsync();
            var model = response.Ok();
            Assert.IsType<SemanticCacheStats>(model);
        }
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task InvalidateAllAsyncTest()
        {
            var response = await _instance.InvalidateAllAsync();
            var model = response.Ok();
            Assert.IsType<InvalidateResponse>(model);
        }
        ...
        {
            SemanticCacheConfig semanticCacheConfig = default!;
            await _instance.UpdateConfigAsync(semanticCacheConfig);
        }
    }
}
