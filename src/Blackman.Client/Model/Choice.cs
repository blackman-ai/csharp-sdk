...
namespace Blackman.Client.Model
{
    ...
    /// Choice
    /// </summary>
    public partial class Choice : IValidatableObject
    {
        /// <summary>
        ...
        [JsonConstructor]
        public Choice(int index, Message message, Option<string?> finishReason = default)
        {
            Index = index;
            Message = message;
    ...
    /// <summary>
    /// A Json converter for type <see cref="Choice" />
    /// </summary>
    public class ChoiceJsonConverter : JsonConverter<Choice>
    {
        /// <summary>
        /// Deserializes json to <see cref="Choice" />
        /// </summary>
        ...
        public override Choice Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!index.IsSet)
                throw new ArgumentException("Property is required for class Choice.", nameof(index));

            if (!message.IsSet)
                throw new ArgumentException("Property is required for class Choice.", nameof(message));

            if (index.IsSet && index.Value == null)
                throw new ArgumentNullException(nameof(index), "Property is not nullable for class Choice.");

            if (message.IsSet && message.Value == null)
                throw new ArgumentNullException(nameof(message), "Property is not nullable for class Choice.");

            return new Choice(index.Value!.Value!, message.Value!, finishReason);
        }

        /// <summary>
        /// Serializes a <see cref="Choice" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="choice"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, Choice choice, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, choice, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="Choice" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="choice"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, Choice choice, JsonSerializerOptions jsonSerializerOptions)
        {
            if (choice.Message == null)
                throw new ArgumentNullException(nameof(choice.Message), "Property is required for class Choice.");

            writer.WriteNumber("index", choice.Index);

            writer.WritePropertyName("message");
            JsonSerializer.Serialize(writer, choice.Message, jsonSerializerOptions);
            if (choice.FinishReasonOption.IsSet)
                if (choice.FinishReasonOption.Value != null)
                    writer.WriteString("finish_reason", choice.FinishReason);
                else
