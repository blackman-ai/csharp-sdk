...
namespace Blackman.Client.Model
{
    ...
    /// CompletionOptions
    /// </summary>
    public partial class CompletionOptions : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CompletionOptions" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public CompletionOptions(Option<int?> maxTokens = default, Option<List<string>?> stop = default, Option<bool?> stream = default, Option<float?> temperature = default, Option<float?> topP = default)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CompletionOptions {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="CompletionOptions" />
    /// </summary>
    public class CompletionOptionsJsonConverter : JsonConverter<CompletionOptions>
    {
        /// <summary>
        /// Deserializes json to <see cref="CompletionOptions" />
        /// </summary>
        ...
        public override CompletionOptions Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new CompletionOptions(maxTokens, stop, stream, temperature, topP);
        }

        /// <summary>
        /// Serializes a <see cref="CompletionOptions" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="completionOptions"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, CompletionOptions completionOptions, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, completionOptions, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="CompletionOptions" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="completionOptions"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, CompletionOptions completionOptions, JsonSerializerOptions jsonSerializerOptions)
        {
            if (completionOptions.MaxTokensOption.IsSet)
                if (completionOptions.MaxTokensOption.Value != null)
                    writer.WriteNumber("max_tokens", completionOptions.MaxTokensOption.Value!.Value);
                else
                    writer.WriteNull("max_tokens");

            if (completionOptions.StopOption.IsSet)
                if (completionOptions.StopOption.Value != null)
                {
                    writer.WritePropertyName("stop");
                    JsonSerializer.Serialize(writer, completionOptions.Stop, jsonSerializerOptions);
                }
                else
                    writer.WriteNull("stop");
            if (completionOptions.StreamOption.IsSet)
                if (completionOptions.StreamOption.Value != null)
                    writer.WriteBoolean("stream", completionOptions.StreamOption.Value!.Value);
                else
                    writer.WriteNull("stream");

            if (completionOptions.TemperatureOption.IsSet)
                if (completionOptions.TemperatureOption.Value != null)
                    writer.WriteNumber("temperature", completionOptions.TemperatureOption.Value!.Value);
                else
                    writer.WriteNull("temperature");

            if (completionOptions.TopPOption.IsSet)
                if (completionOptions.TopPOption.Value != null)
                    writer.WriteNumber("top_p", completionOptions.TopPOption.Value!.Value);
                else
